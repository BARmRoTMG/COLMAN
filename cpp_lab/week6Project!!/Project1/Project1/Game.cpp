...
//------------------------------------------------------------------------------------------------//
Game::Game()
	//: m_window(sf::VideoMode(800, 600), "Advanced Lab Project")
{
}
//------------------------------------------------------------------------------------------------//
Game::~Game()
...
void Game::InitStates()
{
    ...
    m_stateMachine.registerState<PlayState>("play", m_factory,
        [this]() { m_stateMachine.changeState("pause"); },
        [this]() { m_stateMachine.changeState("menu"); }
    );

    m_stateMachine.registerState<PauseState>("pause", m_factory,
        [this]() { m_stateMachine.changeState("play"); }
    );
